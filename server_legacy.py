...
mcp = FastMCP(
    ...
    instructions="You are an expert in controlling Android devices using uiautomator2. Provide accurate and efficient responses to the user's requests regarding device operations.",
    )
